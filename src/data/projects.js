...
import motel6Flagstaff from '../assets/portfolio/commercial/Motel_6_Flagstaff.webp';
import embassySuitesHouston from '../assets/portfolio/commercial/Embassy_Suites_Houston.webp';
import fairfieldInnKingman from '../assets/portfolio/commercial/Fairfield_Inn_Kingman.webp';
...
import spiritMountainCasino from '../assets/portfolio/commercial/Spirit_Mountain_Casino.webp';
import super8Kingman from '../assets/portfolio/commercial/Super_8_Kingman.webp';
import courtyardMarriottHesperia from '../assets/portfolio/commercial/Courtyard_Marriott_Hesperia.webp';
import ramadaInnKingman from '../assets/portfolio/commercial/Ramada_Inn_Kingman.webp';
import qualityInnKingman from '../assets/portfolio/commercial/Quality_Inn_Kingman.webp';
...
import daysInnKingman from '../assets/portfolio/commercial/Days_Inn_Kingman.webp';
import clarionInnKingman from '../assets/portfolio/commercial/Clarion_Inn_Kingman.webp';
import bestWesternKingman from '../assets/portfolio/commercial/Best_Western_Kingman.webp';
import northernAzFireDistrict from '../assets/portfolio/commercial/Northern_AZ_Fire_District.webp';
...
import siennaVillas from '../assets/portfolio/commercial/Sienna_Villas.webp';
import schifferCourtApartments from '../assets/portfolio/commercial/Schiffer_Court_Apartments.webp';
import rivyveBehavioralHealth from '../assets/portfolio/commercial/Rivyve_Behavioral_Health.webp';
import legacySeniorCenter from '../assets/portfolio/commercial/Legacy_Senior_Center.webp';
import hilltopVillas from '../assets/portfolio/commercial/Hilltop_Villas.webp';
import hualapaiMountainCampus from '../assets/portfolio/commercial/Hualapai_Mountain_Campus.webp';
...
import farmCrestHome from '../assets/portfolio/residential/Farm_Crest_Home_Kingman.webp';
import golfHomeKingman from '../assets/portfolio/residential/Golf_Home_Kingman.webp';
import laughlinRanch1 from '../assets/portfolio/residential/Laughlin_Ranch_1.webp';
import laughlinRanch2 from '../assets/portfolio/residential/Laughlin_Ranch_2.webp';
import modelHomeBullhead from '../assets/portfolio/residential/Model_Home_Bullhead.webp';
import modelHomeFortMohave from '../assets/portfolio/residential/Model_Home_Fort_Mohave.webp';
import modelHomeKingman from '../assets/portfolio/residential/Model_Home_Kingman.webp';
...
export const commercialProjects = [
  // ── Featured ──────────────────────────────────────────────────────────────
  {
    ...
    featured: true,
    seoDescription: "Canyon State delivered roofing, metals, and three-coat stucco on Betty's Village, Opportunity Village's Las Vegas community for adults with disabilities.",
    ...
    gallery: [
      ...
      { src: bettysVillageCover, caption: "A broad aerial view of Betty's Village taking shape. The clubhouse standing seam waterfall roof is front and center, surrounded by 22 residential dwellings and three commercial buildings all under construction simultaneously." },
      ...
      { src: bettysVillage7, caption: "The centerpiece of Betty's Village is the clubhouse, which features a striking standing seam waterfall roof. This complex application required a roll former, multiple telehandlers, and experienced applicators managing 70-foot continuous panels. Canyon State completed the 3-coat stucco, coping metal, cap metal, standing seam metal, 80-mil TPO, and all custom flashings." },
      { src: bettysVillage8, caption: "A closer look at the standing seam waterfall detail on the clubhouse, one of the more demanding installations in Canyon State's portfolio." },
      { src: bettysVillage9, caption: "The retail building takes shape as Canyon State crews lay out the 80-mil TPO system with tapered ISO crickets." },
      { src: bettysVillage10, caption: "Canyon State employees tied off and working through the tile roof layout at Building 2." },
  ...
  { id: 'lds-church-litchfield', name: 'LDS Church Addition', location: 'Litchfield Park, AZ', category: 'government', trade: 'Roofing', src: ldsChurchLitchfield },
  { id: 'spirit-mountain-casino', name: 'Spirit Mountain Casino', location: 'Fort Mohave, AZ', category: 'hospitality', trade: 'Roofing', src: spiritMountainCasino, comingSoon: true },
  { id: 'echo-suites-chandler', name: 'Echo Suites', location: 'Chandler, AZ', category: 'hospitality', trade: 'Roofing', src: echoSuitesChandler, comingSoon: true },
  { id: 'marriott-townplace-hesperia', name: 'Marriott Townplace Suites', location: 'Hesperia, CA', category: 'hospitality', trade: 'Roofing', src: marriottTownplaceHesperia, comingSoon: true },
  { id: 'marriott-studio-phoenix', name: 'Marriott Studio Res', location: 'Phoenix, AZ', category: 'hospitality', trade: 'Roofing', src: marriottStudioPhoenix, comingSoon: true },
  ...
  { id: 'fairfield-inn-kingman', name: 'Fairfield Inn', location: 'Kingman, AZ', category: 'hospitality', trade: 'Roofing', src: fairfieldInnKingman },
  { id: 'hampton-inn-del-rio', name: 'Hampton Inn', location: 'Del Rio, TX', category: 'hospitality', trade: 'Roofing', src: hamptonInnDelRio },
  ...
  { id: 'red-roof-inn-hesperia', name: 'Red Roof Inn', location: 'Hesperia, CA', category: 'hospitality', trade: 'Roofing', src: redRoofInnHesperia },
  ...
  { id: 'super-8-kingman', name: 'Super 8', location: 'Kingman, AZ', category: 'hospitality', trade: 'Roofing', src: super8Kingman },
  { id: 'courtyard-marriott-hesperia', name: 'The Courtyard by Marriott', location: 'Hesperia, CA', category: 'hospitality', trade: 'Roofing', src: courtyardMarriottHesperia },
  { id: 'ramada-inn-kingman', name: 'Ramada Inn', location: 'Kingman, AZ', category: 'hospitality', trade: 'Roofing', src: ramadaInnKingman },
  { id: 'quality-inn-kingman', name: 'Quality Inn', location: 'Kingman, AZ', category: 'hospitality', trade: 'Roofing', src: qualityInnKingman },
  { id: 'quality-inn-barstow', name: 'Quality Inn', location: 'Barstow, CA', category: 'hospitality', trade: 'Roofing', src: qualityInnBarstow },
  { id: 'motel-6-kingman', name: 'Motel 6', location: 'Kingman, AZ', category: 'hospitality', trade: 'Roofing', src: motel6Kingman },
  { id: 'avid-hilton-kingman', name: 'Avid by Hilton', location: 'Kingman, AZ', category: 'hospitality', trade: 'Roofing', src: avidHiltonKingman, comingSoon: true },
  { id: 'aloft-north-carolina', name: 'Aloft', location: 'North Carolina', category: 'hospitality', trade: 'Roofing', src: aloftNorthCarolina },
  ...
  { id: 'silver-queen-kingman', name: 'Silver Queen', location: 'Kingman, AZ', category: 'hospitality', trade: 'Roofing', src: silverQueenKingman },
  { id: 'hampton-inn-kingman', name: 'Hampton Inn', location: 'Kingman, AZ', category: 'hospitality', trade: 'Roofing', src: hamptonInnKingman },
  { id: 'days-inn-kingman', name: 'Days Inn', location: 'Kingman, AZ', category: 'hospitality', trade: 'Roofing', src: daysInnKingman },
...
export const residentialProjects = [
  { id: 'custom-home-kingman-3', name: 'Custom Home No. 3', location: 'Kingman, AZ', category: 'custom-home', trade: 'Roofing & Stucco', src: customHome3 },
  { id: 'custom-home-kingman-4', name: 'Custom Home No. 4', location: 'Kingman, AZ', category: 'custom-home', trade: 'Roofing & Stucco', src: customHome4 },
  { id: 'custom-home-kingman-5', name: 'Custom Home No. 5', location: 'Kingman, AZ', category: 'custom-home', trade: 'Roofing', src: customHome5 },
  { id: 'custom-home-kingman-6', name: 'Custom Home No. 6', location: 'Kingman, AZ', category: 'custom-home', trade: 'Roofing', src: customHome6 },
  ...
  { id: 'farm-crest-home-kingman', name: 'Farm Crest Home', location: 'Kingman, AZ', category: 'custom-home', trade: 'Roofing & Stucco', src: farmCrestHome },
  { id: 'golf-home-kingman', name: 'Golf Home', location: 'Kingman, AZ', category: 'custom-home', trade: 'Roofing', src: golfHomeKingman },
  { id: 'laughlin-ranch-1', name: 'Laughlin Ranch No. 1', location: 'Laughlin, NV', category: 'development', trade: 'Roofing & Stucco', src: laughlinRanch1 },
  { id: 'laughlin-ranch-2', name: 'Laughlin Ranch No. 2', location: 'Laughlin, NV', category: 'development', trade: 'Roofing & Stucco', src: laughlinRanch2 },
  { id: 'model-home-bullhead', name: 'Model Home', location: 'Bullhead City, AZ', category: 'model-home', trade: 'Roofing', src: modelHomeBullhead },
  { id: 'model-home-fort-mohave', name: 'Model Home', location: 'Fort Mohave, AZ', category: 'model-home', trade: 'Roofing', src: modelHomeFortMohave },
  { id: 'model-home-kingman', name: 'Model Home', location: 'Kingman, AZ', category: 'model-home', trade: 'Roofing', src: modelHomeKingman },
  ...
  { id: 'custom-home-kingman-7', name: 'Custom Home No. 7', location: 'Kingman, AZ', category: 'custom-home', trade: 'Roofing & Stucco', src: customHomeKingman7 },
